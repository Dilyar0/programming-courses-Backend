...
def create_students():
    student1 = Student(full_name="Макс", age=22, is_married=False, marks={
        "биология": 5,
        "история": 4,
        "математика": 5,
        "физика": 2,
    ...
    student2 = Student(full_name="Андрей", age=15, is_married=False, marks={
        "биология": 4,
        "история": 5,
        "математика": 2,
        "физика": 5,
    ...
    student3 = Student(full_name="Георгий", age=19, is_married=False, marks={
        "биология": 5,
        "история": 1,
        "математика": 5,
        "физика": 4,
